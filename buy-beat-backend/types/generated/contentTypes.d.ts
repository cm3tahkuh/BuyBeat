...
export interface ApiBeatFileBeatFile extends Struct.CollectionTypeSchema {
  collectionName: 'beat_files';
  info: {
    displayName: 'BeatFile';
    pluralName: 'beat-files';
    singularName: 'beat-file';
  };
  options: {
  ...
  attributes: {
    ...
    license_type: Schema.Attribute.Enumeration<['lease', 'exclusive']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    type: Schema.Attribute.Enumeration<
      ['MP3', 'WAV', 'STEMS', 'PROJECT', 'MELODY', 'EXCLUSIVE']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBeatBeat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audio_preview: Schema.Attribute.Media<'audios'>;
    beat_files: Schema.Attribute.Relation<
      'oneToMany',
      'api::beat-file.beat-file'
    >;
    ...
    >;
    visibility: Schema.Attribute.Enumeration<['PUBLIC', 'SOLD_EXCLUSIVE']>;
  };
}
...
export interface ApiGenreGenre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    beats: Schema.Attribute.Relation<'oneToMany', 'api::beat.beat'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    file_attachment: Schema.Attribute.Media<
...
export interface ApiPurchasePurchase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    beat_file: Schema.Attribute.Relation<
      'manyToOne',
      'api::beat-file.beat-file'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    license_pdf: Schema.Attribute.Media<'files'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    beats: Schema.Attribute.Relation<'manyToMany', 'api::beat.beat'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiWalletEntryWalletEntry extends Struct.CollectionTypeSchema {
  collectionName: 'wallet_entries';
  info: {
    displayName: 'WalletEntry';
    pluralName: 'wallet-entries';
    singularName: 'wallet-entry';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::wallet-entry.wallet-entry'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['topup', 'purchase', 'payout']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWalletWallet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    users_permissions_user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    wallet_entries: Schema.Attribute.Relation<
      'oneToMany',
      'api::wallet-entry.wallet-entry'
    >;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    app_role: Schema.Attribute.Enumeration<
      ['artist', 'producer', 'admin', 'super_admin']
    >;
    ...
    is_onboarded: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::wallet-entry.wallet-entry': ApiWalletEntryWalletEntry;
